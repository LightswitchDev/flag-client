...
var LightswitchProvider = function (_a) {
    ...
    var _c = React.useState(initialSwitches), lightswitches = _c[0], setSwitches = _c[1];
    lightswitchClient.subscribe(function (lightswitches) {
        console.log('subscribe', lightswitches);
        setSwitches(lightswitches);
    });
    return React__default.createElement(Provider, { value: { lightswitches: lightswitches, lightswitchClient: lightswitchClient } }, children);
};
